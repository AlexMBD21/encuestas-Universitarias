  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose || onCancel} maxWidth="max-w-3xl" hideMobileIndicator={true} scrollableBody={false}>
      <div className="flex flex-col h-full sm:max-h-[85vh] relative overflow-hidden">
        ...
        {/* Header — teal sólido */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 shrink-0 rounded-t-[2rem] sm:rounded-[1.5rem] sm:rounded-b-none pt-8 sm:pt-4 z-10 border-b border-white/10" style={{ backgroundColor: 'var(--color-primary)' }}>
          <h3 className="text-lg sm:text-xl font-bold text-white tracking-wide">Configurar Evaluadores</h3>
